...
export const communicationsData = [
  {
    ...
    outcome: {
      ...
      description:
        "Agreed on timeline coordination. InnovateBX gets first response by Feb 10, StartupCZ waits until Feb 12.",
      actions: [
...
export const notificationsData = [
  {
    ...
    message:
      "Anjali Singh from StartupCZ wants to discuss candidate Arjun Kumar",
    priority: "HIGH",
    isRead: false,
    createdAt: "2024-01-20T15:00:00.000Z",
  },
