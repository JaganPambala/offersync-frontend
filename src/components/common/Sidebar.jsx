...
const Sidebar = ({ sidebarOpen, setSidebarOpen, isMobile = false }) => {
  ...
  const navigation = [
    {
      name: navigationLinks.dashboard.name,
      href: navigationLinks.dashboard.path,
      icon: LayoutDashboard,
    },
    {
      name: navigationLinks.candidateCheck.name,
      href: navigationLinks.candidateCheck.path,
      icon: Users,
    },
    {
      name: navigationLinks.offers.name,
      href: navigationLinks.offers.path,
      icon: FileText,
    },
    {
      name: navigationLinks.communications.name,
